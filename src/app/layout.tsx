    ...
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div className="flex shrink-0 items-center">
          ...
          src="https://eng-test-files.object.pscloud.io/Pictures/catTest.webp?AWSAccessKeyId=470KBLII3TCJXEMRUNGX&Expires=1744362985&Signature=Xp%2Fe1y2s72SsXPa09iX4QQLNWzE%3D" 
          alt="Cat meme"/>
        </div>
        <div className="hidden sm:ml-6 sm:block">
          <div className="flex space-x-4">
            ...
            <Link href="/admin/dashboard" className="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white" aria-current="page">Dashboard</Link>
            <Link href="/admin/questions" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Questions</Link>
            <Link href="/admin/users" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Users</Link>
          </div>
        </div>
      </div>
