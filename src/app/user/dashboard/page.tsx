                ...
                <div className="row">
                    <div className="col-5 vstack">
                        ...
                        }</h3>
                        {
                            ...
                            <Link className="page-button btn"  href={`/user/buy`}>КУПИТЬ ТЕСТЫ</Link>
                            <Link className="page-button btn" style={{width:'9rem', height:'2.5rem', color: 'white', backgroundColor: '#5669BB'}} href={`/user/myTests`}>МОИ ТЕСТЫ</Link>
                        {
                            loading &&
                            <p>
                                Загрузка
