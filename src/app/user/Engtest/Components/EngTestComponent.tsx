  ...
  useEffect(() => {
    ...
    if (CurrentQ === null)
      ...
      switch (CurrentQ.qpoId) {
        ...
        case 5:( setWindow(<QuestionsWindows.RACQWindow question={CurrentQ as RACQ } submitAnswer={submitAnswer}/>) );break;
        ...
        case 11:( setWindow(<QuestionsWindows.EssayQWindow question={CurrentQ as EssayQ } submitAnswer={submitAnswer}/>) );break;
        case 12:( setWindow(<QuestionsWindows.IRQWindow question={CurrentQ as IRQ } submitAnswer={submitAnswer}/>) );break;
        case 13:( setWindow(<QuestionsWindows.ILQWindow question={CurrentQ as ILQ } submitAnswer={submitAnswer}/>) );break;
